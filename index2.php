...
<body>
	...
	<section id="home" class="welcome-hero">
		...
		<div class="container">
		<form method = "get" action = "tambahdatapelanggan.php" >
			<div class="row">
				<div class="col-md-12">
								...
								<div class="single-model-search">
									...
									<div class="model-select-icon">
										<select class="form-control" name="tujuan">
											...
											<option value="pekanbaru">PEKANBARU</option><!-- /.option-->

											<option value="padang">PADANG</option><!-- /.option-->
											<option value="medan">MEDAN</option><!-- /.option-->
								...
								<div class="single-model-search">
									...
									<div class="model-select-icon">
										<select class="form-control" name="lokasi">
											...
											<option value="terminal">TERMINAL</option><!-- /.option-->

											<option value="rumah">RUMAH</option><!-- /.option-->
								...
								<div class="single-model-search">
									...
									<div class="model-select-icon">
										<select class="form-control" name="posisi">
											...
											<option value="depan">DEPAN</option><!-- /.option-->

											<option value="tengah">TENGAH</option><!-- /.option-->
											<option value="belakang">BELAKANG</option><!-- /.option-->
								...
								<div class="single-model-search">
									...
									<div class="model-select-icon">
										<select class="form-control" name="tipe">
											...
											<option value="ekonomi">EKONOMI</option><!-- /.option-->

											<option value="bisnis">BISNIS</option><!-- /.option-->
											<option value="eksklusif">EKSKLUSIF</option><!-- /.option-->
								...
								<div class="single-model-search">
									...
									<div class="model-select-icon">
										<select class="form-control" name="harga">
											...
											<option value="120000">Rp. 120.000</option><!-- /.option-->

											<option value="150000">Rp. 150.000</option><!-- /.option-->
											<option value="180000">Rp. 180.000</option><!-- /.option-->
											<option value="230000">Rp. 230.000</option><!-- /.option-->
											<option value="250000">Rp. 250.000</option><!-- /.option-->
											<option value="280000">Rp. 280.000</option><!-- /.option-->
											<option value="350000">Rp. 350.000</option><!-- /.option-->
											<option value="400000">Rp. 400.000</option><!-- /.option-->
